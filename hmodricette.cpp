...
HModRicette::HModRicette(QSqlDatabase pdb, QWidget *parent) :
    QWidget(parent),
...
void HModRicette::createNewRecipe(QString p_nome, int p_tipo)
{
    bool b;
    /*bool ok;
    //nuova ricetta
    ...
    */
    ...
    int tipo=0;
        ...
        QSqlQuery q(db);
        q.prepare(sql);
        q.bindValue(":descrizione",p_nome);
...
void HModRicette::on_pushButton_3_clicked()
{
    ...
    connect(f,SIGNAL(OK(QString,int)),this,SLOT(createNewRecipe(QString,int)));

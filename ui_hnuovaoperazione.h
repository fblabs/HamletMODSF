...
public:
    ...
    QLabel *label_3;
    QLabel *label_5;
    QDateTimeEdit *deDataOperazione;
    ...
    void setupUi(QWidget *HnuovaOperazione)
    {
        ...
        HnuovaOperazione->resize(1090, 570);
        ...
        label_15 = new QLabel(HnuovaOperazione);
        ...
        leBolla = new QLineEdit(HnuovaOperazione);
        leBolla->setObjectName(QStringLiteral("leBolla"));

        gridLayout->addWidget(leBolla, 5, 2, 1, 1);
        ...
        deDataOperazione = new QDateTimeEdit(HnuovaOperazione);
        deDataOperazione->setObjectName(QStringLiteral("deDataOperazione"));

        gridLayout->addWidget(deDataOperazione, 1, 2, 1, 1);


        formLayout_2->setLayout(3, QFormLayout::LabelRole, gridLayout);
        ...
        formLayout_2->setLayout(3, QFormLayout::FieldRole, formLayout);
        ...
        label_16 = new QLabel(HnuovaOperazione);
        label_16->setObjectName(QStringLiteral("label_16"));

        horizontalLayout_5->addWidget(label_16);

        leNote = new QLineEdit(HnuovaOperazione);
        leNote->setObjectName(QStringLiteral("leNote"));

        horizontalLayout_5->addWidget(leNote);
    ...
    void retranslateUi(QWidget *HnuovaOperazione)
    {
        ...
        label_4->setText(QApplication::translate("HnuovaOperazione", "Bolla:", 0));
        label_15->setText(QApplication::translate("HnuovaOperazione", "Data:", 0));
        ...
        label_16->setText(QApplication::translate("HnuovaOperazione", "Note:", 0));

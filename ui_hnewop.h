...
public:
    ...
    void setupUi(QWidget *HNewOp)
    {
        ...
        verticalLayout = new QVBoxLayout(HNewOp);
        ...
        label_3 = new QLabel(HNewOp);
        label_3->setObjectName(QStringLiteral("label_3"));

        verticalLayout_4->addWidget(label_3);

        label_11 = new QLabel(HNewOp);
        label_11->setObjectName(QStringLiteral("label_11"));

        verticalLayout_4->addWidget(label_11);

        label_7 = new QLabel(HNewOp);
        label_7->setObjectName(QStringLiteral("label_7"));

        verticalLayout_4->addWidget(label_7);

        label_4 = new QLabel(HNewOp);
        ...
        radioButton = new QRadioButton(HNewOp);
        radioButton->setObjectName(QStringLiteral("radioButton"));
        radioButton->setChecked(true);

        horizontalLayout_3->addWidget(radioButton);

        radioButton_2 = new QRadioButton(HNewOp);
        ...
        label_9 = new QLabel(HNewOp);
        label_9->setObjectName(QStringLiteral("label_9"));

        verticalLayout_2->addWidget(label_9);

        listView = new QListView(HNewOp);
        ...
        pushButton = new QPushButton(HNewOp);
        ...
        pushButton_2 = new QPushButton(HNewOp);
    ...
    void retranslateUi(QWidget *HNewOp)
    {
        ...
        label_2->setText(QApplication::translate("HNewOp", "Tipo prodotto", 0));
        ...
        label_4->setText(QApplication::translate("HNewOp", "Bolla:", 0));

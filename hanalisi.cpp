...
void HAnalisi::getYearlyProduction()
{
        ...
        QString sql="SELECT DISTINCT prodotti.ID,prodotti.descrizione from prodotti,lotdef where prodotti.ID=lotdef.prodotto and prodotti.tipo=2 and lotdef.anagrafica=:cliente order by prodottti.descrizione asc";

...
public:
    ...
    void setupUi(QWidget *HModifyProd)
    {
        ...
        rbProdottiFiniti = new QRadioButton(HModifyProd);
        ...
        rbPackeges = new QRadioButton(HModifyProd);
        rbPackeges->setObjectName(QStringLiteral("rbPackeges"));
        rbPackeges->setChecked(false);

        horizontalLayout_3->addWidget(rbPackeges);
    ...
    void retranslateUi(QWidget *HModifyProd)
    {
        ...
        rbProdottiFiniti->setText(QApplication::translate("HModifyProd", "Prodotti finiti", 0));
        rbPackeges->setText(QApplication::translate("HModifyProd", "Packages", 0));
